...
- [ripple](./ripple/) - Pre-change impact analysis agent. Evaluates change risk across vertical (dependency chains, affected files) and horizontal (pattern consistency, naming) dimensions. Does not write code.
...
| `ripple` | Pre-change impact analysis agent. Evaluates change risk across vertical (dependency chains, affected files) and horizontal (pattern consistency, naming) dimensions. Does not write code. | [目录](./ripple/) | [SKILL.md](./ripple/SKILL.md) |
