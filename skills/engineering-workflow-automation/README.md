...
| `guardian` | Git/PR gatekeeper that classifies change essence, recommends granularity, naming, and strategy. Use when PR preparation or commit strategy is needed. | [目录](./guardian/) | [SKILL.md](./guardian/SKILL.md) |
| `harvest` | Collect GitHub PR data and generate work reports. Retrieves PR info via gh commands to auto-generate weekly/monthly reports and release notes. Use when work reporting or PR analysis is needed. | [目录](./harvest/) | [SKILL.md](./harvest/SKILL.md) |
