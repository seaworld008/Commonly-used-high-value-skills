...
| `lark-whiteboard` | 飞书画板查看、导出、编辑和结构化内容可视化。 | [目录](./lark-whiteboard/) | [SKILL.md](./lark-whiteboard/SKILL.md) |
...
| `lark-workflow-meeting-summary` | 汇总会议纪要、提炼结论并生成结构化报告。 | [目录](./lark-workflow-meeting-summary/) | [SKILL.md](./lark-workflow-meeting-summary/SKILL.md) |
