...
| `compete` | Competitive research, differentiation analysis, and strategic positioning. Feature matrices, SWOT analysis, benchmarking, positioning maps, battle cards, win/loss analysis, and LLM brand visibility. Research only — does not write code. | [目录](./compete/) | [SKILL.md](./compete/SKILL.md) |
...
| `growth` | SEO (meta/OGP/JSON-LD/heading hierarchy), SMO (social sharing), CRO (CTA/form/exit-intent), and GEO (AI citation optimization) across four pillars. Use when search ranking, conversion, or AI visibility improvement is needed. | [目录](./growth/) | [SKILL.md](./growth/SKILL.md) |
...
| `pulse` | KPI definition, tracking event design, and dashboard specification. North Star Metric, funnel analysis, and cohort analysis design. GA4/Amplitude/Mixpanel/PostHog integration. Use when metrics foundation is needed. | [目录](./pulse/) | [SKILL.md](./pulse/SKILL.md) |
