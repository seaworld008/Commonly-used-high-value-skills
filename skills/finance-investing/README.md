...
| `saas-metrics-coach` | 用于 SaaS 关键指标分析与健康度诊断，包含 ARR/MRR/Churn/LTV/CAC 等核心指标。来源：alirezarezvani/claude-skills。 | [目录](./saas-metrics-coach/) | [SKILL.md](./saas-metrics-coach/SKILL.md) |
