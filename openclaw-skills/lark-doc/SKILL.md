...
- Use this skill when the user explicitly asks for 飞书云文档 work in Feishu/Lark.
...
- Discover the relevant `lark-cli docs` command surface with `--help` before composing requests.
...
lark-cli docs --help | sed -n '1,80p'
```
