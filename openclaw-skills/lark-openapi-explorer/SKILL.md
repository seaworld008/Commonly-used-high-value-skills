...
- Use this skill when the user explicitly asks for 飞书原生 OpenAPI work in Feishu/Lark.
...
- Discover the relevant `lark-cli api` command surface with `--help` before composing requests.
