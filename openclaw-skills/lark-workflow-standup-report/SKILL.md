...
- Use this skill when the user explicitly asks for 站会摘要工作流 work in Feishu/Lark.
...
- Discover the relevant `lark-cli calendar` command surface with `--help` before composing requests.
...
lark-cli calendar --help | sed -n '1,80p'
```
