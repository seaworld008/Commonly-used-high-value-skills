...
[![Skills](https://img.shields.io/badge/Skills-255-7c3aed)](./skills/)

面向中文 AI 开发者的高价值 Skills 仓库，覆盖开发工程、DevOps、产品设计、运营、办公自动化、金融投资、AI 平台与安全治理等高频任务场景。当前共 **16 个分类 / 255 个技能**。
...
### 9. 项目管理与知识库集成（knowledge-and-pm-integrations，11）
...
### 12. 安全治理与稳定性（security-and-reliability，10）
